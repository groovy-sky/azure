# Azure's VMs audit with NMAP and PowerShell (part 1)
...
[This article's image](https://raw.githubusercontent.com/groovy-sky/docker/master/azure-audit/Dockerfile) is build up from [Powershell 6.0 image](https://blogs.msdn.microsoft.com/powershell/2018/01/10/powershell-core-6-0-generally-available-ga-and-supported/), which uses [Az module](https://docs.microsoft.com/en-us/powershell/azure/new-azureps-module-az?view=azps-1.2.0) and [NMAP package](https://nmap.org/). At the start of container it will execute ['Invoke-Audit' function](https://raw.githubusercontent.com/groovy-sky/docker/master/azure-audit/main.psm1)
